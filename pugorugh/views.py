...
# get the next dog and show only undecided dogs
class DogFilterView(generics.RetrieveAPIView):
    permission_classes = (permissions.IsAuthenticated,)
    serializer_class = serializers.DogSerializer

    # queryset for user search
    ...
    def get_queryset(self):
        ...
        # queryset based on ages and user preferences
...
class DogViewSet(viewsets.ModelViewSet):
    ...
    # view route for dog/<pk>/disliked
    @detail_route(methods=['POST', 'PUT'])
    ...
    # view route for dog/<pk>/undecided
    @detail_route(methods=['POST', 'PUT'])
